		...
		<div className="flex flex-col h-full justify-between">
			<div className=" px-4 sm:px-6 mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
				<div className="sm:col-span-6">
					<label
						htmlFor="title"
						className="block text-sm/8 font-bold text-gray-700"
					>
						Title
					</label>
					<div className="mt-2">
			...
			<div className="mt-8 flex justify-end gap-4  px-4 sm:px-6 border-t border-gray-200 py-4">
				<button
					type="button"
					onClick={onCancel}
					className="hover:cursor-pointer inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-gray-700 bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
				>
					Cancel
				</button>
				<button
					...
					className="hover:cursor-pointer inline-flex justify-center py-2 px-4 bg-[#DCF763] border border-[#435058] shadow-sm text-sm font-medium rounded-md text-whit hover:font-bold focus:outline-none focus:ring-2 focus:ring-offset-2"
				>
					Save
				</button>
			</div>
