        ...
        <div className="p-4">
          {selectedBook && (
            <div className="space-y-4">
              <h1 className="text-3xl font-bold text-center">{selectedBook.title}</h1>
              <p className="text-xl text-center text-gray-600">{selectedBook.author}</p>
              <div className="flex justify-center gap-2">
                <Stars note={selectedBook.note} />
                <span className="text-gray-600 text-md">{selectedBook.note}</span>
              </div>
              <div className="flex justify-center">
              <img src={selectedBook.img} alt={selectedBook.title} className="w-80 h-120 rounded-lg shadow-lg" />
              </div>
              <p className="text-lg text-justify leading-relaxed">{selectedBook.description}</p>
            </div>
          )}
        </div>
