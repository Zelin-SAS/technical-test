...
import { AcademicCapIcon, BeakerIcon, BookOpenIcon, GlobeAltIcon, LightBulbIcon, SparklesIcon, UsersIcon, VariableIcon, ViewColumnsIcon } from '@heroicons/react/24/outline';
                ...
                {Categories.map((category, index) => (
                    <div key={index} className="hover:cursor-pointer flex items-center w-max min-w-60 space-x-4 p-4 bg-white rounded-lg">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-sm text-gray-600">{category.nbItems} items</span>
                        </div>
                    </div>
                ))}
            </div>
